...
-- (2) Essa consulta serve para visualizar a idade média de anos programando dos usuários, de forma a relacionar com sua escolaridade. De modo geral, observou-se que as maiores médias estão presentes no grupo de pessoas que possuem maiores graus de escolaridade.
...
-- (3) Analogamente, buscou-se analisar a relação entre a idade média de anos programando  dos usuários, mas agrupando-os por país. Países de menor desenvolvimento possuem, em média, usuários menos experientes em programação.
